                ...
                <div class="row mb-4 wow fadeIn">
                    ...
                    <div class="col-lg-6 col-md-3 mb-4 serviceform">
                        ...
                        <form class="card" action="/horoscope" enctype="multipart/form-data" method="post" style="width: 100%;">
                            ...
                            <div class="p-3 text-left">
                                <p> Naming a child based on his or her horoscope or rashi is considered to bring good luck. Child astrology report is a boon to new parents! You get the perfect picture of your child inner strenghts and weekness and gives u the direction that works best for your child.</p>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-3 mb-4">
                        ...
                        <div class="card mb-4 serviceside ">
                            ...
                            <!--Card image-->
                            <div class="view overlay">
                                <img src="<?php echo e(asset('astrolifeguide')); ?>/img/services/pandit2.webp" style="width:40%;" class="mx-auto card-img-top"
                                     alt="">
