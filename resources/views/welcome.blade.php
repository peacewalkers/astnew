        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
                <div class="view bannerview">
                    <img class="d-block w-100" src="{{asset('astrolifeguide')}}/img/header/slide-41.JPG"
                         alt="First slide">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="content">
                                    <h1 class="text-white mt-4">AstroLifeGuide</h1>
                                    <h5 class="text-white m-3">Your Trusted Source For Vedic Astrology Services</h5>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="carousel-item">
                <!--Mask color-->
                <div class="view bannerview">
                    <img class="d-block w-100" src="{{asset('astrolifeguide')}}/img/header/slide-31.JPG"
                         alt="Second slide">
                </div>
              {{--  <div class="carousel-caption">
                    <div class="container">
    ...
    <div class="hs_service_main_wrapper" id="services">
                                ...
                                <div class="card card-ecommerce">
                                    <a href="/services/horoscope">
                                        ...
                                        <div class="services-image text-center  mx-auto">
                                            ...
                                            <img src="{{ asset('astrolifeguide') }}/img/services/horoscope.webp" class="img-fluid"  alt="">
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 mb-4">
                                ...
                                <div class="card card-ecommerce">
                                    <a href="/services/child">
                                        ...
                                        <!--Card image-->
                                        <div class="services-image text-center  mx-auto">
                                            <img src="{{ asset('astrolifeguide') }}/img/services/child.webp" class="" style="width: 115%;" alt="">
                                            <div class="mask rgba-white-slight"></div>
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 mb-4">
                                ...
                                <div class="card card-ecommerce">
                                    <a href="/services/career">
                                        <!--Card image-->
                                        <div class="services-image text-center  mx-auto">
                                            <img src="{{ asset('astrolifeguide') }}/img/services/Career.webp" class=""  style="width: 96%;" alt="career prediction">
                                            <div class="mask "></div>
                                ...
                                <div class="card card-ecommerce">
                                    <a href="/services/matchmaker">
                                        ...
                                        <div class="services-image text-center  ">
                                            <img src="{{ asset('astrolifeguide') }}/img/services/manglik.webp"  style="width: 150%;" class="text-center"  alt="matchmaking">
                                            <div class="mask rgba-white-slight"></div>
                                        </div>
                                        <!--Card image-->
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 mb-4">
                                <a href="/services/vastu">
                                    ...
                                    <div class="card card-ecommerce">
                                        <!--Card image-->
                                        <div class="services-image text-center  mx-auto">
                                            <img src="{{ asset('astrolifeguide') }}/img/services/vastu2.webp" class="img-fluid"  alt="">
                                            <div class="mask rgba-white-slight"></div>
                                        </div>
                                        <!--Card image-->
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 mb-4">
                                <a href="/services/sadesati">
                                    ...
                                    <div class="card card-ecommerce">
                                        <!--Card image-->
                                        <div class="services-image text-center  mx-auto">
                                            <img src="{{ asset('astrolifeguide') }}/img/services/saturday.webp" class="img-fluid"  alt="career prediction">
                                            <div class="mask rgba-white-slight"></div>
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 mb-4">
                                <a href="/services/remedies">
                                    ...
                                    <div class="card card-ecommerce">
                                        ...
                                        <!--Card image-->
                                        <div class="services-image text-center  mx-auto">
                                            <img src="{{ asset('astrolifeguide') }}/img/services/vastu.webp" class="img-fluid"  alt="">
                                            <div class="mask rgba-white-slight"></div>
                                        </div>
                                        <!--Card image-->
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 mb-4">
                                <a href="/services/muhurtham">
                                    ...
                                    <div class="card card-ecommerce">
                                        ...
                                        <!--Card image-->
                                        <div class="services-image text-center  mx-auto">
                                            <img src="{{ asset('astrolifeguide') }}/img/services/pandit2.webp" class="text-center"  alt="matchmaking">
                                            <div class="mask rgba-white-slight"></div>
                                        </div>
                                        <!--Card image-->
                            ...
                            <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6 mb-4">
                                <a href=#>
                                    ...
                                    <div class="card card-ecommerce">
                                        ...
                                        <!--Card image-->
                                        <div class="services-image text-center  mx-auto">
                                            <img src="{{ asset('astrolifeguide') }}/img/services/gemelogy.webp" class="img-fluid"  alt="">
                                            <div class="mask rgba-white-slight"></div>
                                        </div>
                                        <!--Card image-->
                        ...
                        <div class="ui-mobile-container card-shadow ui-margin-t d-md-none" align="center">
                            ...
                            <div class="ui-home-icon">
                                <a href="/services/horoscope" title="Detailed Horoscope">
                                    <img src="{{ asset('astrolifeguide') }}/img/services/horoscope.webp"  alt="Detailed Horoscope" style="width: 65px !important; margin-top: 12px;" title="horoscope">
                            ...
                            <div class="ui-home-icon">
                                <a href="/services/child" title="Child Report">
                                    <img src="{{ asset('astrolifeguide') }}/img/services/child.webp" alt="child Report" style="width:85px; padding-top:5px;" title="child report">
                                    <p class="ui-home-text">
                                        Child Report
                                    </p>
                                </a>
                            ...
                            <div class="ui-home-icon">
                                <a href="/services/career" title="Career Report">
                                    <img src="{{ asset('astrolifeguide') }}/img/services/Career.webp"  alt="health report" style="width: 65px !important; margin-top: 15px;" title="career report">
                                    <p class="ui-home-text">
                                        Career Report
                                    </p>
                                </a>
                            ...
                            <div class="ui-home-icon">
                                <a href="/services/matchmaker" title="Compatibilty Report">
                                    <img src="{{ asset('astrolifeguide') }}/img/services/manglik.webp" alt="compatibility report" style="width:100px !important; padding-top:5px" title="Compatibility Report">
                            ...
                            <div class="ui-home-icon">
                                <a href="/services/vastu" title="Vastu Report">
                                    <img src="{{ asset('astrolifeguide') }}/img/services/vastu2.webp" style="width:65px; padding-top:10px;" alt="Vastu Report" title="Vastu Report">
                            ...
                            <div class="ui-home-icon">
                                <a href="/services/sadesati" title="Sade Sati Report">
                                    <img src="{{ asset('astrolifeguide') }}/img/services/saturday.webp" alt="Sade Sati Report" style="width:70px; padding-top: 8px;">
                            ...
                            <div class="ui-home-icon">
                                <a href="/services/remedies" title="Vedic Remedies">
                                    <img src="{{ asset('astrolifeguide') }}/img/services/vastu.webp"  alt="Vedic Remedies" style="width: 60px !important; margin-top: 10px;" title="Vedic Remedies">
                            ...
                            <div class="ui-home-icon">
                                <a href="/services/gemelogy" title="Gemology Report">
                                    <img src="{{ asset('astrolifeguide') }}/img/services/gemelogy.webp" alt="Gemology Report" style="width:70px; padding-top: 5px;" title="Gemology Report">
                                    <p class="ui-home-text" style="padding-top: 2px;">
                                        Gemelogy
                                    </p>
                                </a>
        ...
        <div class="hs_sign_wrapper">
            <div class="container">
                ...
                <div class="row d-none d-md-flex">
                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                        <div class="hs_sign_box">
                            <div class="sign_box_img">
                                <img src="{{ asset('astrolifeguide') }}/img/content/icon1.webp" width="70" alt="icon1">
                            </div>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                        <div class="hs_sign_box">
                            <div class="sign_box_img">
                                <img src="{{ asset('astrolifeguide') }}/img/content/icon2.webp" width="70"  alt="icon2">
                            </div>
                            <div class="sign_box_cont">
                                <h2>Taurus</h2>
                                <p>20 Apr - 20 May</p>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                        <div class="hs_sign_box">
                            <div class="sign_box_img">
                                <img src="{{ asset('astrolifeguide') }}/img/content/icon3.webp" width="70"  alt="icon3">
                            </div>
                            <div class="sign_box_cont">
                                <h2>Gemini</h2>
                                <p>21 May - 20 Jun </p>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                        <div class="hs_sign_box">
                            <div class="sign_box_img">
                                <img src="{{ asset('astrolifeguide') }}/img/content/icon4.webp" width="70"  alt="icon4">
                            </div>
                            <div class="sign_box_cont">
                                <h2>Cancer</h2>
                                <p>21 Jun - 22 Jul</p>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                        <div class="hs_sign_box">
                            <div class="sign_box_img">
                                <img src="{{ asset('astrolifeguide') }}/img/content/icon5.webp" width="70"  alt="icon5">
                            </div>
                            <div class="sign_box_cont">
                                <h2>leo</h2>
                                <p>23 Jul - 22 Aug</p>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                        <div class="hs_sign_box">
                            <div class="sign_box_img">
                                <img src="{{ asset('astrolifeguide') }}/img/content/icon6.webp" width="70" alt="icon6">
                            </div>
                            <div class="sign_box_cont">
                                <h2>Virgo</h2>
                                <p>23 Aug - 22 Sep</p>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                        <div class="hs_sign_box">
                            <div class="sign_box_img">
                                <img src="{{ asset('astrolifeguide') }}/img/content/icon7.webp" width="70"  alt="icon7">
                            </div>
                            <div class="sign_box_cont">
                                <h2>Libra</h2>
                                <p>23 Sep - 22 Oct</p>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                        <div class="hs_sign_box">
                            <div class="sign_box_img">
                                <img src="{{ asset('astrolifeguide') }}/img/content/icon8.webp" width="70"  alt="icon8">
                            </div>
                            <div class="sign_box_cont">
                                <h2>Scorpio</h2>
                                <p>22 Oct - 21 Nov</p>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                        <div class="hs_sign_box">
                            <div class="sign_box_img">
                                <img src="{{ asset('astrolifeguide') }}/img/content/icon9.webp" width="70"  alt="icon9">
                            </div>
                            <div class="sign_box_cont">
                                <h2>Sagittairus</h2>
                                <p>22 Nov  - 21 Dec</p>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                        <div class="hs_sign_box">
                            <div class="sign_box_img">
                                <img src="{{ asset('astrolifeguide') }}/img/content/icon10.webp" width="70"  alt="icon10">
                            </div>
                            <div class="sign_box_cont">
                                <h2>Capricorn</h2>
                                <p>22 Dec - 19 Jan</p>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                        <div class="hs_sign_box">
                            <div class="sign_box_img">
                                <img src="{{ asset('astrolifeguide') }}/img/content/icon11.webp" width="70"  alt="icon11">
                            </div>
                            <div class="sign_box_cont">
                                <h2>Aquarius</h2>
                                <p>20 Jan - 18 Feb</p>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
                        <div class="hs_sign_box">
                            <div class="sign_box_img">
                                <img src="{{ asset('astrolifeguide') }}/img/content/icon12.webp" width="70"  alt="icon12">
                            </div>
                            <div class="sign_box_cont">
                                <h2>Pisces</h2>
                                <p>19 Feb - 20 Mar</p>
                ...
                <div class="ui-mobile-container card-shadow ui-margin-t d-md-none" align="center">
                    ...
                    <div class="ui-home-icon">
                        <a href="#" title="Health
            Problem">
                            <img src="{{ asset('astrolifeguide') }}/img/content/icon11_m.webp"  alt="Health
            ...
            Problem">
                    ...
                    <div class="ui-home-icon">
                        <a href="#">
                            <img src="{{ asset('astrolifeguide') }}/img//content/icon12_m.webp" alt="Pisces" style="width:90px; padding-top:10px;" title="Pisces">
                            <p class="ui-home-text">
                                Pisces<br>
                                19 Feb - 20 Mar</p>
                        </a>
                    ...
                    <div class="ui-home-icon">
                        <a href="#" title="aries">
                            <img src="{{ asset('astrolifeguide') }}/img//content/icon1_m.webp"  alt="aries" style="width: 90px !important; margin-top: 10px;" title="aries">
                            <p class="ui-home-text">
                                Aries</br>
                                21 Mar - 19 Apr</p>
                        </a>
                    ...
                    <div class="ui-home-icon">
                        <a href="#" title="Taurus">
                            <img src="{{ asset('astrolifeguide') }}/img//content/icon2_m.webp" alt="taurus" style="width: 90px; padding-top:10px;" title="taurus">
                            <p class="ui-home-text">
                                Taurus</br>
                                20 Apr - 20 May</p>
                        </a>
                    ...
                    <div class="ui-home-icon">
                        <a href="#" title="gemini">
                            <img src="{{ asset('astrolifeguide') }}/img//content/icon3_m.webp" alt="gemini" style="width:90px !important; padding-top:10px" title="gemini">
                            <p class="ui-home-text">
                                Gemini</br>
                                21 May - 20 Jun</p>
                        </a>
                    ...
                    <div class="ui-home-icon">
                        <a href="#">
                            <img src="{{ asset('astrolifeguide') }}/img//content/icon11_m.webp" alt="Cancer" style="width:90px; padding-top:10px" title="Cancer">
                            <p class="ui-home-text">
                                Cancer</br>
                                21 Jun - 22 Jul</p>
                        </a>
                    ...
                    <div class="ui-home-icon">
                        <a href="#" title="leo">
                            <img src="{{ asset('astrolifeguide') }}/img//content/icon5_m.webp" style="width:90px; padding-top:10px;" alt="leo" title="leo">
                            <p class="ui-home-text" >
                                Leo</br>
                                23 Jul - 22 Aug</p>
                        </a>
                    ...
                    <div class="ui-home-icon">
                        <a href="#">
                            <img src="{{ asset('astrolifeguide') }}/img//content/icon6_m.webp" alt="virgo" style="width:90px; padding-top: 10px;">
                            <p class="ui-home-text">
                                Virgo</br>
                                23 Aug - 22 Sep</p>
                        </a>
                    ...
                    <div class="ui-home-icon">
                        <a href="#" title="libra">
                            <img src="{{ asset('astrolifeguide') }}/img//content/icon7_m.webp" alt="libra" style="width:90px !important; padding-top: 10px;" title="libra">
                            <p class="ui-home-text">
                                Libra</br>
                                23 Sep - 22 Oct</p>
                        </a>
                    ...
                    <div class="ui-home-icon">
                        <a href="#" title="Scorpio">
                            <img src="{{ asset('astrolifeguide') }}/img//content/icon8_m.webp"  alt="Scorpio" style="width: 90px !important; margin-top: 10px;" title="Scorpio">
                            <p class="ui-home-text" style="padding-top: 5px;">
                                Scorpio</br>
                                23 Oct - 21 Nov</p>
                        </a>
                    ...
                    <div class="ui-home-icon">
                        <a href="#">
                            <img src="{{ asset('astrolifeguide') }}/img//content/icon9_m.webp" alt="Sagittaaairus" style="width:90px; padding-top: 10px;" title="Sagittaaairus">
                            <p class="ui-home-text">
                                Sagittaaairus</br>
                                22 Nov - 21 Dec</p>
                        </a>
                    ...
                    <div class="ui-home-icon">
                        <a href="#">
                            <img src="{{ asset('astrolifeguide') }}/img//content/icon10_m.webp" alt="Capricorn" style="width:90px; padding-top: 10px;" title="Capricorn">
                            <p class="ui-home-text" style="padding-top: 2px;">
                                Capricorn</br>
                                22 Dec - 19 Jan</p>
                        </a>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="hs_about_left_img_wrapper">
                            <img src="{{ asset('astrolifeguide') }}/img/content/about_img1.webp" alt="about_img" />
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="hs_about_heading_main_wrapper">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <div class="testimonial_slider_content">
                                                <img src="{{ asset('astrolifeguide') }}/img/content/testi_client_img1.webp" style="margin-top: -60px;" class="img-responsive" alt="section3_t2__img">
                                                <h5>Mr & Mrs Venkat</h5>
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 hidden-xs">
                                            <div class="testimonial_slider_content">
                                                <img src="{{ asset('astrolifeguide') }}/img/content/testi_client_img3.webp" style="margin-top: -60px;" class="img-responsive" alt="section3_t2__img">
