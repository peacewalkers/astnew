                    ...
                    <div class="col-lg-6 col-md-3 mb-4 serviceform">
                        ...
                        <form class="card" action="/horoscope" enctype="multipart/form-data" method="post" style="width: 100%;">
                            ...
                            <div class="p-3 text-left">
                                <p>We provide remedies for all the important events in a person life, according to their horoscope such as Child Birth, Education, Career, Health, Financial growth etc.</p>
                            </div>
