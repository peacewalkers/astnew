                ...
                <div class="row mb-4 wow fadeIn">
                    ...
                    <div class="col-lg-6 col-md-3 mb-4 serviceform">
                        ...
                        <form class="card" action="/horoscope" enctype="multipart/form-data" method="post" style="width: 100%;">
                            @csrf
                            <h5 class="my-3 py-2 text-uppercase text-white" style="background-color:#038c01;"> Child Report</h5>
                            <input type="hidden" name="reptype" value="Child">
                            <div class="p-3 text-left">
                                <p> Naming a child based on his or her horoscope or rashi is considered to bring good luck to the child. Child astrology report is a boon to new parents! Our chld report gives you the perfect picture of your childs' inner strenghts and weekness and the direction that works best for your child.</p>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-3 mb-4">
                        ...
                        <div class="card mb-4 serviceside ">
                            ...
                            <!--Card image-->
                            <div class="view overlay">
                                <img src="{{ asset('astrolifeguide') }}/img/services/pandit2.webp" style="width:40%;" class="mx-auto card-img-top"
                                     alt="">
