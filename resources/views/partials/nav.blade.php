        ...
        <div class="hs_header_logo_right">
            <nav class="hs_main_menu">
                <ul class="menubuttons">
                    <li>
                    <li><a class="menu-button" href="{{url('')}}">HOME</a></li>
                    ...
                    <li class="nav-item dropdown menu-button">
                        <a class="menu-button nav-link dropdown-toggle" href="{{url('')}}/#services">SERVICES</a>
                        <ul class="dropdown-menu hs_mega_menu">
                            <li>
                                <a class="menu-button" href="{{url('')}}/services/horoscope">Detailed Horoscope</a>
                            </li>
                            <li>
                                <a class="menu-button  " href="{{url('')}}/services/matchmaker">Compatibility</a>
                            </li>
                            <li>
                                <a class="menu-button " href="{{url('')}}/services/child">Child Report</a>
                            </li>
                            <li>
                                <a class="menu-button " href="{{url('')}}/services/marriage">Marriage Report</a>
                            </li>
                            <li>
                                <a class="menu-button " href="{{url('')}}/services/career">Career Report</a>
                            </li>
                            <li>
                    ...
                    @else
                        <li class="nav-item dropdown menu-button">
                            ...
                            <ul class="dropdown-menu hs_mega_menu">
                                <li>
                                    <a class="menu-button {{ Request::is('profile/'.Auth::user()->name, 'profile/'.Auth::user()->name . '/edit') ? '' : null }}" href="{{ url('/profile/'.Auth::user()->name) }}">
                                ...
                                @endrole
                                <li>
                                    <a class="menu-button " href="{{ route('logout') }}"
